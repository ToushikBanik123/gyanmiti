...
//
// class EnrolledTestSeriesList extends StatefulWidget {
//   final String category;
//   EnrolledTestSeriesList({required this.category, Key? key}) : super(key: key);
//
//   @override
//   State<EnrolledTestSeriesList> createState() => _EnrolledTestSeriesListState();
// }
//
// class _EnrolledTestSeriesListState extends State<EnrolledTestSeriesList> {
//   List<ExamListExamTileModel> examList = [];
//   Future<void> fetchData({required String uid}) async {
//     final Uri apiUrl =
//         Uri.parse("https://gyanmeeti.in/API/enrolled_exam_list.php");
//
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10.sp),
                        Text(
                          exam.examName ?? '', // Use the null-aware operator
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.aBeeZee(
                            fontSize: 16.sp,
                        ...
                        SizedBox(height: 5.sp),
                        Text(
                          "by ${exam.createdBy ?? ''}", // Use the null-aware operator
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.aBeeZee(
                            fontSize: 9.sp,
                        ...
                        SizedBox(height: 10.sp),
                        Text(
                          "${exam.session ?? ''}", // Use the null-aware operator
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.aBeeZee(
                            fontSize: 10.sp,
